      ...
      <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="space-y-4">
            ...
            <p class="text-gray-600 text-sm">MovieRating is dedicated to providing movie enthusiasts with a premium platform to share their viewing experiences.</p>
          </div>
          <!-- Quick Links -->
          <div class="space-y-4">
        ...
        <div class="border-t border-gray-200 mt-8 pt-8 text-center">
          <p class="text-sm text-gray-600">&copy; 2025 MovieRating. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </div>
